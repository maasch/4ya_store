      ...
      <div className="main">
        <div className="products-grid">
          {/* <div className="product-container">
            ...
            <div className="added-to-cart js-added-to-cart-e43638ce-6aa0-4b85-b27f-e1d07eb678c6">
              <img src="images/icons/checkmark.png" />
              Added
            </div>

            <button className="add-to-cart-button button-primary add-to-cart-js" data-product-id="e43638ce-6aa0-4b85-b27f-e1d07eb678c6">
              Add to Cart
            </button>
          </div>
          ...
          <div className="product-container">
            ...
            <div className="product-quantity-container">
              <select className="js-quantity-selected-15b6fc6f-327a-4ec4-896f-486349e85a3d">
                <option selected="" value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
                <option value="4">4</option>
            ...
            <div className="added-to-cart js-added-to-cart-15b6fc6f-327a-4ec4-896f-486349e85a3d">
              <img src="images/icons/checkmark.png" />
              Added
            </div>
